...
public class ScotlandPlannedRoadworks extends Fragment {

    private Feed feed;// get the data
    private xmlParser parser; // Extract the data
    private ListView lstItemsPlannedRoadworks; // Widget in roadworks fragment
    ...
    public ScotlandPlannedRoadworks() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_scotland_planned_roadworks, container, false);
        // create objects
        feed = new Feed();
        parser = new xmlParser();
        // get references
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("TRAFFIC SCOTLAND PLANNED ROADWORKS");
        lstItemsPlannedRoadworks = view.findViewById(R.id.lstItemsPlannedRoadworks);//
        //Listeners
        new DownloadFeed().execute(urlPlannedRoadworks);
        //return view to the layout
        return view;
    }
    ...
    public class ReadFeed extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result){
            ...
            //update the display
            ScotlandPlannedRoadworks.this.updateDisplay();
        }
    }
    ...
    public void updateDisplay()
    {
        ...
        if(getActivity() != null){
            ...
            lstItemsPlannedRoadworks.setAdapter(adapter);
        }
    }
}